...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/cap5/TestCase01_ues_paper}
...
{\includegraphics[width=0.3\linewidth]{img/cap5/TestCase01_ues_l1.eps}}\qquad
\subfigure[\protect\url{l = 2}]%
{\includegraphics[width=0.3\linewidth]{img/cap5/TestCase01_ues_l2.eps}}\qquad
\subfigure[\protect\url{l = 3}]%
{\includegraphics[width=0.3\linewidth]{img/cap5/TestCase01_ues_l3.eps}}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{img/cap5/TestCase02_ues_paper}
...
\centering%
\subfigure[\protect\url{l = 1}]%
{\includegraphics[width=0.3\linewidth]{img/cap5/TestCase02_ues_l1.eps}}\qquad
\subfigure[\protect\url{l = 2}]%
{\includegraphics[width=0.3\linewidth]{img/cap5/TestCase02_ues_l2.eps}}\qquad
\subfigure[\protect\url{l = 3}]%
{\includegraphics[width=0.3\linewidth]{img/cap5/TestCase02_ues_l3.eps}}
