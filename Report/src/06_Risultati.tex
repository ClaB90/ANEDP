...
{\includegraphics[width=0.3\linewidth]{img/cap6/TestCase01_ues_l1.eps}}\qquad
\subfigure[\protect\url{l = 2}]%
{\includegraphics[width=0.3\linewidth]{img/cap6/TestCase01_ues_l2.eps}}\qquad
\subfigure[\protect\url{l = 3}]%
{\includegraphics[width=0.3\linewidth]{img/cap6/TestCase01_ues_l3.eps}}
...
\centering%
\subfigure[\protect\url{l = 1}]%
{\includegraphics[width=0.3\linewidth]{img/cap6/TestCase02_ues_l1.eps}}\qquad
\subfigure[\protect\url{l = 2}]%
{\includegraphics[width=0.3\linewidth]{img/cap6/TestCase02_ues_l2.eps}}\qquad
\subfigure[\protect\url{l = 3}]%
{\includegraphics[width=0.3\linewidth]{img/cap6/TestCase02_ues_l3.eps}}
